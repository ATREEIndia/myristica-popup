export const info=[
    {
        ...
        position:{left:'65.6%',top:'22.4%'},
        img_url:"/hornbill.jpg",
        title:"Malabar Grey Hornbill",
        sciName:"Ocyceros griseus",
        content:<span>
            India is home to nine species of hornbills, of which four are found in the Western Ghats. These large, predominantly frugivorous birds mate for life: partnerships are formed after competing males perform mid-air acrobatics for potential mates. The winning male presents fruits to his female counterpart, and the pair then go off in search of a suitable tree cavity in which to lay their nest. The female hornbill enters the cavity alone, plastering and sealing herself inside with only a small slit left open for contact with her mate. Through this opening, the male hornbill slips his young family a variety of insects and fruits, including figs and <i>Myristica</i>.

        </span>
    },
    {
       
        position:{left:'95.6%',top:'32.4%'},
    ...
    ,
    {
        ...
        content:<span>
          Often, <i>Myristica</i> swamps are found alongside evergreen forests. Evergreen species like <i>Lophopetalum wightianum</i> , Elaeocarpus tuberculatus, Dipterocarpus indicus are found mostly in such sacred forests, which have been protected for centuries by local communities. A study found that the basal area of trees (i.e. the thickness of their trunks) in <i>Myristica</i> swamps is much higher than elsewhere, indicating that these swamps are mature, old growth habitats, practically impossible to replace. This gigantic <i>Lophopetalum</i> tree also has large, snaking ‘serpentine’ roots, which give it support in swampy soils.
    ...
    ,
    {
        ...
        content:<span>
      Perhaps the most distinctive member of the family, with stilt roots rising from the base of the tree stem. A close relative of ‘true nutmeg’ (<i>Myristica fragrans,</i> native to the Spice Islands of Indonesia), evidenced by their similar fruit and seeds. We derive the valuable nutmeg spice from the seed of this Indonesian fruit, while its brightly coloured seed coating or ‘aril’ gives us the mace spice.
        </span>
    }
    ,
    {
       
        position:{left:'60.6%',top:'66.4%'},
    ...
    ,
    {
        ...
        position:{left:'44.6%',top:'72.4%'},
        img_url:"/02-04-damselfly-768x579.jpg",
        title:"Myristica Bambootail",
        sciName:"Phylloneura westermanni",
        content:<span>
